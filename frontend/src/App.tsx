            ...
            >
              ...
              >
                ...
                <span className="font-display font-extrabold text-white text-lg tracking-tight">
                  Dr. M. Sathyakala<span className="text-white font-light">.</span>
                </span>
              </div>
                  ...
                  >
                    <div className="bg-white text-slate-900 border border-slate-200 rounded-2xl shadow-2xl p-5 pb-7 ">
                      ...
                      <div className="pb-3 border-b border-slate-100 mb-3">
                        <h3 className="text-sm font-bold text-slate-900">Dr. M. Sathyakala</h3>
                        <p className="text-[10px] text-slate-400 font-mono">Assistant Professor, IT Department</p>
                      </div>
                      ...
                      <div className="flex flex-col gap-3.5 text-xs text-slate-700">
                        <div className="space-y-0.5">
                          ...
                          <p className="font-bold text-slate-800 leading-normal">M.Tech., Ph.D.</p>
                        </div>
                        <div className="space-y-0.5">
                          <p className="text-[9px] font-mono font-bold uppercase tracking-wider text-slate-400 leading-none">Specialization</p>
                          <p className="font-semibold text-slate-800 leading-normal">Data Mining & Pattern Recognition</p>
                        </div>
                        <div className="space-y-0.5">
                          <p className="text-[9px] font-mono font-bold uppercase tracking-wider text-slate-400 leading-none">Experience</p>
                          <p className="font-semibold text-slate-800 leading-normal">15 Years Teaching & Research</p>
                        </div>
                        <div className="space-y-0.5">
